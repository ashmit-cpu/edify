...
const AboutUs = () => {
  return (
    <section className="global_sections aboutus-testimonials academic-sec podcast-nobg d-none d-md-block">
      <div className="row">
        <div className="col">
      ...
      <div className="row">
        <div className="col-lg-10 ac-mx-auto">
          <div className="position-relative officer-slider ">
            <Swiper
              ...
              breakpoints={{
                ...
                1430: { slidesPerView: 3, spaceBetween: 20 },
              }}
            >
              {updates &&
                updates?.map((item, index) => {
                  return (
                    <SwiperSlide key={`officer${index}`}>
                      <div className="aboutus-item ac-h-[300px] ac-max-h-[300px] ac-min-h-[300px]">
                        {/* <div className="img">
                          <Image
                            src={item?.image}
                            alt="image"
                        ...
                        <div className="details">
                          <div className={`${outfit.className} date`}>
                            {item?.date}
                          </div>
                          <div className={`${outfit.className} name`}>
                            {item?.name}
                          </div>
                          <div
                            className={`${outfit.className} description ac-text-xs `}
                          >
                            {item?.description}
                          </div>
                        </div> */}
                        ...
                        <div className="ac-p-5">
                          <div className="top-section ac-flex ">
                            <Image
                              src={item?.image}
                              alt="image"
                              width={100}
                            ...
                            />
                            <div className={`${outfit.className} name ac-pl-4 ac-flex-col`}>
                              {item?.name}
                              <p>   {item?.date}</p>
                            </div>
                          </div>
                          ...
                          <div
                            className={`${outfit.className} description ac-text-xs ac-pt-6`}
                          >
                            {item?.description}
                          </div>
                        </div>
            ...
            <div className="swiper-nav text-end mt-0 mt-md-3 mb-4 mb-md-0">
