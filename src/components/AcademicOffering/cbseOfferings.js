...
"
                    ...
                    <Tab eventKey="Grade-12" title="Grade 11 Commerce">
                        <div className="nav-tab-container">
                            <Row className="g-4">
                                <Col lg={7} md={12}>
                                    <div className="grade-container">
                    ...
                    <Tab eventKey="Grade-13" title="Grade 11 Humanities">
                        <div className="nav-tab-container">
                            <Row className="g-4">
                                <Col lg={7} md={12}>
                                    <div className="grade-container">
                                ...
                                <Col lg={5} md={12}>
                                    <div className="fee-container">
                                        ...
                                        <div className="fee-content">
                                            <div className="fees">
                                                <div className="fee-txt">Tution Fees</div>
                                                <div className="fee-amt">₹ 228,000.00</div>
                                            </div>
                                ...
                                <Col lg={5} md={12}>
                                    <div className="fee-container">
                                        ...
                                        <div className="fee-content">
                                            <div className="fees">
                                                <div className="fee-txt">Tution Fees</div>
                                                <div className="fee-amt">₹ 229,500.00</div>
                                            </div>
                                            ...
                                            <div className="fees">
                                                ...
                                                <div className="fee-amt">₹ 123,000.00</div>
                                            </div>
                        ...
                        title={
                            <>
                                <div className="custom-flex">
                                    Grade 11 & 12 +&nbsp;
                                    <Image
                                        src="/images/icons/trisha-logo.svg"
                                        alt="allen"
                                        width={70}
                                        height={20}
                                        className="me-1 hover-img"
                                    />
                                    {/* <Image
                              src="/images/icons/Mode-logo.svg"
                              alt="allen"
