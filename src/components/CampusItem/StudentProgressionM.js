        ...
        <div className="row flex-column-reverse flex-lg-row">
          <div className="col-lg-8">
            ...
            <p className="card-txt">
              The Student Progression Plan ensures focused attention for
              students to excel in academics, sports, co-curricular activities,
...
export default StudentProgressionM;
