        ...
        <div className="row align-items-center justify-content-between flex-column-reverse flex-lg-row">
          <div className="col-lg-8">
            ...
            <p className="card-txt">
              We focus on indoor and outdoor sports, offering students the
              choice to excel in their preferred disciplines. Students are
              encouraged to participate in competitions with support from
              dedicated coaches for each sport.
            </p>
            ...
            <div className="row">
              ...
              <div className="col-6">
                ...
                <div className="d-flex justify-content-start align-items-center card-high ms-0">
                  ...
                  />
                  <div className="ms-2">
                    <p className="card-head px-0 mb-0">Cricket</p>
                  </div>
                </div>
                <div className="d-flex justify-content-start align-items-center card-high ms-0">
                  <Image
