...
function AgricultureM() {
  const [showModal, setShowModal] = useState(false);
  const handleCloseModal = () => setShowModal(false);
  const handleShowModal = () => setShowModal(true);
  return (
    <div>
      <div className="right-cards yellow-bgs p-4">
        <div className="row justify-content-between flex-column-reverse flex-lg-row">
          <div className="col-lg-7">
            ...
            <p className="card-txt">
              Students learn farming from sowing seeds to harvesting crops,
              gaining hands-on experience in hard work and sustainability.
              Harvested produce nourishes the community, giving them a sense of
              accomplishment. The Goshala teaches animal care, connecting them
            ...
            <div className="row mt-3">
              ...
              <div className="col-6">
                ...
                <div className="d-flex justify-content-start align-items-center card-high">
                  ...
                  />
                  <div className="ms-2">
                    <p className="card-head px-0 mb-0">Community Learning</p>
                  </div>
                </div>
              </div>
            </div>
